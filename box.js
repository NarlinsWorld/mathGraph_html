class Box {
    constructor(myscale, xmin, xmax, xbox, ymin, ymax, ybox) {
    ...
    thebox(xmin, xmax, xbox, ymin, ymax, ybox) {
        push();
        //textFont(tahoma);
        textSize(this.fsize);
        noFill();
        ...
        for (let i = 0; i < floor(xbox + 1); i++) {
            ...
            line(tix, this.lowerLeft.y, tix, this.lowerLeft.y - 25 * this.myscale); // the tic line            
        ...
        for (let i = 0; i < floor(ybox+1); i++) {
            ...
            strokeWeight(3);
            line(this.lowerLeft.x, tix, this.lowerLeft.x + 25 * this.myscale, tix); //draw the tic
